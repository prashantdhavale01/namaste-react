      ...
      <div key={item?.card?.info?.name} className="flex justify-between p-3 mt-2 border border-solid border-[#ddd] rounded-xl">
        ...
        <div>
          <div className="h-[100] w-[120] relative">
            ...
            <button onClick={()=>handleAddItems(item)} type="button" className="bg-white px-3 border border-solid border-[#999] rounded-md absolute left-0 right-0 m-auto -bottom-3 w-20 font-bold text-green-700">+ Add</button>
          </div>
